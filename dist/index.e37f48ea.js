...
},{"core-js/modules/web.immediate.js":"49tUX","./model.js":"Y4A21","./views/recipeView.js":"l60JC","regenerator-runtime/runtime":"dXNgZ","./views/searchView.js":"9OQAM","./views/resultsView.js":"cSbZE","./views/paginationView.js":"6z7bi","./views/bookmarksView.js":"4Lqzq","./views/addRecipeView.js":"i6DNj","./config.js":"k5Hzs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"49tUX":[function(require,module,exports) {
"use strict";
...
function createRecipeObject(data1) {
...
async function loadRecipe(id) {
    try {
        data = await (0, _helpersJs.AJAX)(`${(0, _configJs.API_URL)}/${id}?key=${(0, _configJs.KEY)}`);
...
async function loadSearchResults(query) {
    try {
        ...
        const data1 = await (0, _helpersJs.AJAX)(`${(0, _configJs.API_URL)}/?search=${query}&key=${(0, _configJs.KEY)}`);
        state.search.results = data1.data.recipes.map((rec)=>{
            return {
                id: rec.id,
                title: rec.title,
...
async function uploadRecipe(newRecipe) {
    try {
        const ingredients = Object.entries(newRecipe).filter((entry)=>entry[0].startsWith("ingredient") && entry[1] !== "").map((ing)=>{
            ...
            if (ingArr.length !== 3) throw new Error("Wrong ingredient format! Please use this format: quantity,unit,description");
        ...
        const data1 = await (0, _helpersJs.AJAX)(`${(0, _configJs.API_URL)}?search=${recipe.title}&key=${(0, _configJs.KEY)}`, recipe);
...
const KEY = "6ba75d94-d355-4239-9a8a-0f7573df72da";
...
class RecipeView extends (0, _viewJsDefault.default) {
    ...
    _errorMessage = "Recipe not found! Please try a different recipe.";
    _message = "";
...
class ResultsView extends (0, _viewJsDefault.default) {
    ...
    _message = "";
    _generateMarkup() {
        return this._data.map((boomark)=>(0, _previewViewJsDefault.default).render(boomark, false)).join("");
    }
}
